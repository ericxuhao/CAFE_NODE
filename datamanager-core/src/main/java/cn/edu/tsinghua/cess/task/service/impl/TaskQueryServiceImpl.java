...
public class TaskQueryServiceImpl implements TaskQueryService {
    ...
    @Override
    public SubTaskResult[] queryTaskResult(Integer taskId) {
        List<SubTaskListEntry> subTaskList = taskQueryDao.querySubTaskList(taskId);
        
        log.info("query subTaskListEntry of [taskId=" + taskId + "], got [" + subTaskList + "]");
