...
public class NclOutput {
    private static String TempFolder="/usr/local/cmip5_tmp/";
    //private static String TempFolder="/mnt/CMIP5/cmip5_tmp/";
    private static String ncl_path="/usr/local/ncl/bin/ncl";
    private static String ncl_env="NCARG_ROOT=/usr/local/ncl";
    private static String ScriptFolder="/usr/local/nclscripts/";
